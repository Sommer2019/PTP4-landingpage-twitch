...
export default function BartclickerGame({compact = false}: BartclickerGameProps) {
    ...
    const BOOSTERS = [
        {
            id: 0,
            name: t('bartclicker.booster.turboBoost'),
            icon: '⚡',
            effect: t('bartclicker.booster.turboEffect'),
            baseCost: 1000
        },
        {
            id: 1,
            name: t('bartclicker.booster.clickMadness'),
            icon: '💪',
            effect: t('bartclicker.booster.clickEffect'),
            baseCost: 1500
        },
        {
            id: 2,
            name: t('bartclicker.booster.luckyBonus'),
            icon: '🍀',
            effect: t('bartclicker.booster.luckyEffect'),
            baseCost: 2000
        },
    ];
    ...
    const RELICS = [
        {
            id: 0,
            name: t('bartclicker.relics.ancientComb'),
            icon: '🏺',
            effect: t('bartclicker.relics.ancientEffect'),
            baseCost: 25000000
        },
        {
            id: 1,
            name: t('bartclicker.relics.magicalOil'),
            icon: '🧪',
            effect: t('bartclicker.relics.oilEffect'),
            baseCost: 50000000
        },
        {
            id: 2,
            name: t('bartclicker.relics.goldenBeard'),
            icon: '✨',
            effect: t('bartclicker.relics.goldenEffect'),
            baseCost: 100000000
        },
        {
            id: 3,
            name: t('bartclicker.relics.timeOil'),
            icon: '⏳',
            effect: t('bartclicker.relics.timeEffect'),
            baseCost: 200000000
        },
    ];
            ...
            {offlineEarnings && (
                <div className="offline-earnings-banner">
                    ...
                    <div className="offline-earnings-text">
                        ...
                        <span>{t('bartclicker.offline.earned', {
                            amount: formatNumber(offlineEarnings.amount),
                            time: formatOfflineTime(offlineEarnings.seconds)
                        })}</span>
                    </div>
                        ...
                        <div className="booster-content-wrapper">
                            ...
                            <div className="booster-grid">
                                {BOOSTERS.map((booster) => {
                                    ...
                                    return (
                                        <div key={booster.id}
                                             className={`booster-card ${activeBuff ? 'booster-active' : ''}`}>
                    ...
                    {shopTab === 'autobuyer' && (
                        <div className="autobuyer-content">
                            <p className="highlight-warning" style={{fontSize: '0.85rem', marginBottom: '10px'}}>
                                {t('bartclicker.rebirth.spendWarning')}
                                ×{formatNumber(gameState.rebirth_multiplier)})
                            </p>
                            <div className="autobuyer-card">
                                <h3>{t('bartclicker.autobuyer.autoClicker')}</h3>
                                <p>{t('bartclicker.autobuyer.autoClickerDesc')}</p>
                                <p className="muted-text"
                                   style={{fontSize: '0.9rem'}}>{t('bartclicker.autobuyer.autoClickerBoostInfo')}</p>
                                <p className="muted-text"
                    ...
                    {shopTab === 'offline' && (
                        <div className="autobuyer-content">
                            ...
                            <div className="autobuyer-card">
                                ...
                                <p className="muted-text" style={{fontSize: '0.9rem'}}>
                                    {t('bartclicker.offline.upgradesOwned', {
                                        current: gameState.offline_earning_upgrades,
                                        max: MAX_OFFLINE_UPGRADES
                                    })}
                                </p>
                                <p className="muted-text"
                                   style={{fontSize: '0.9rem'}}>{t('bartclicker.offline.youHave', {count: gameState.rebirth_count})}</p>

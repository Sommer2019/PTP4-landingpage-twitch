...
ALTER
SCHEMA "clipvoting" OWNER TO "postgres";
...
ALTER
SCHEMA "onlybart" OWNER TO "postgres";
...
CREATE
OR REPLACE FUNCTION "public"."add_moderator"("p_twitch_user_id" "text", "p_display_name" "text" DEFAULT NULL::"text") RETURNS "jsonb"
...
WHERE id = auth.uid();
IF
v_caller_twitch_id IS NULL THEN
    RETURN jsonb_build_object('error', 'not_authenticated');
END IF;

SELECT NOT EXISTS(SELECT 1 FROM moderators)
INTO v_table_empty;
IF
NOT v_table_empty AND NOT EXISTS(
...
VALUES (p_twitch_user_id, p_display_name, true) ON CONFLICT (twitch_user_id) DO
UPDATE SET
...
CREATE
OR REPLACE FUNCTION "public"."admin_ban_account"("p_twitch_user_id" "text", "p_display_name" "text", "p_banned_by" "text") RETURNS "void"
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
begin
  -- Ensure caller is a moderator (this uses the existing RPC/is_moderator function)
  if
not is_moderator() then
...
values (p_twitch_user_id, p_display_name, p_banned_by) on conflict (twitch_user_id) do
update
...
CREATE
OR REPLACE FUNCTION "public"."admin_ban_account"("p_twitch_user_id" "text", "p_display_name" "text" DEFAULT NULL::"text", "p_banned_by" "text" DEFAULT NULL::"text", "p_reason" "text" DEFAULT NULL::"text") RETURNS "void"
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
DECLARE
u RECORD;
...
VALUES (p_twitch_user_id, p_display_name, p_banned_by, p_reason) ON CONFLICT (twitch_user_id) DO
UPDATE
...
CREATE
OR REPLACE FUNCTION "public"."admin_delete_reward"("p_id" "text") RETURNS "jsonb"
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
DECLARE
...
END IF;
  ...
  IF
NOT (public.is_moderator_role() OR public.is_broadcaster_role() OR public.is_moderator()) THEN
    RETURN jsonb_build_object('error', 'forbidden');
END IF;
...
CREATE
OR REPLACE FUNCTION "public"."admin_unban_account"("p_twitch_user_id_int" integer) RETURNS "jsonb"
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
BEGIN
...
CREATE
OR REPLACE FUNCTION "public"."admin_unban_account"("p_twitch_user_id" "text") RETURNS "void"
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
BEGIN
DELETE
...
CREATE
OR REPLACE FUNCTION "public"."admin_unban_account"("p_twitch_user_id_uuid" "uuid") RETURNS "jsonb"
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
BEGIN
...
CREATE
OR REPLACE FUNCTION "public"."admin_unban_account_json"("p_payload" json) RETURNS "jsonb"
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
DECLARE
v_id text;
...
END IF;
  v_id
:= coalesce((p_payload->>'p_twitch_user_id'), (p_payload->>'twitch_user_id'));
  IF
v_id IS NULL THEN
...
CREATE
OR REPLACE FUNCTION "public"."admin_unban_account_text"("p_twitch_user_id" "text") RETURNS "jsonb"
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
BEGIN
...
CREATE
OR REPLACE FUNCTION "public"."cast_vote"("p_round_id" "uuid", "p_clip_id" "uuid") RETURNS "jsonb"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'clipvoting', 'public'
    AS $$
DECLARE
...
CREATE
OR REPLACE FUNCTION "public"."check_ban_before_login"("event" "jsonb") RETURNS "jsonb"
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
DECLARE
v_twitch_id text;
...
BEGIN
  ...
  v_twitch_id
:= (event->'user_identity'->>'identity_id');
...
CREATE
OR REPLACE FUNCTION "public"."deactivate_all_active_redeemed_global"() RETURNS integer
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
DECLARE
v_count integer := 0;
...
CREATE
OR REPLACE FUNCTION "public"."deactivate_expired_redeemed_global"() RETURNS integer
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
DECLARE
v_count integer := 0;
...
CREATE
OR REPLACE FUNCTION "public"."deactivate_redeemed_global_for_session"("p_session_id" "text") RETURNS integer
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
DECLARE
v_count integer := 0;
...
CREATE
OR REPLACE FUNCTION "public"."ensure_rewards_id"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    AS $$
BEGIN
  IF
NEW.id IS NULL OR NEW.id = '' THEN
...
CREATE
OR REPLACE FUNCTION "public"."get_bartclicker_leaderboard"("p_limit" integer DEFAULT 100) RETURNS TABLE("rank" bigint, "user_id" "uuid", "total_ever" numeric, "rebirth_count" integer, "last_updated" timestamp with time zone)
    LANGUAGE "plpgsql" STABLE
    AS $$
BEGIN
RETURN QUERY
SELECT ROW_NUMBER() OVER (ORDER BY bs.total_ever DESC, bs.rebirth_count DESC) as rank, bs.user_id,
       bs.total_ever,
       bs.rebirth_count,
       bs.last_updated
FROM bartclicker_scores bs
WHERE bs.total_ever > 0
   OR bs.rebirth_count > 0
ORDER BY bs.total_ever DESC, bs.rebirth_count DESC LIMIT p_limit;
END;
$$;
...
CREATE
OR REPLACE FUNCTION "public"."get_bartclicker_leaderboard_with_names"("p_limit" integer DEFAULT 100) RETURNS TABLE("rank" bigint, "user_id" "uuid", "total_ever" numeric, "rebirth_count" integer, "last_updated" timestamp with time zone, "display_name" "text")
    LANGUAGE "plpgsql" STABLE
    AS $$
BEGIN
RETURN QUERY
SELECT ROW_NUMBER() OVER (ORDER BY bs.total_ever DESC, bs.rebirth_count DESC) as rank, bs.user_id,
       ...
       bs.rebirth_count,
       bs.last_updated,
       COALESCE(p.username, 'Player ' || ROW_NUMBER() OVER(ORDER BY bs.total_ever DESC, bs.rebirth_count DESC)
                ::text) ::text as display_name
FROM bartclicker_scores bs
...
CREATE
OR REPLACE FUNCTION "public"."get_page_view_stats"("p_from" timestamp with time zone DEFAULT ("now"() - '30 days'::interval), "p_to" timestamp with time zone DEFAULT "now"()) RETURNS "jsonb"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
DECLARE
...
INTO v_per_page
FROM (SELECT page_path, count(*) AS views
      FROM page_views
      WHERE viewed_at BETWEEN p_from AND p_to
      GROUP BY page_path
      ORDER BY views DESC LIMIT 20) t;

-- Aufrufe pro Tag
SELECT coalesce(jsonb_agg(row_to_json(t)), '[]'::jsonb)
INTO v_per_day
FROM (SELECT viewed_at::date AS day, count(*) AS views
      FROM page_views
      WHERE viewed_at BETWEEN p_from AND p_to
      GROUP BY day
      ORDER BY day) t;
...
FROM (SELECT redirect_info ->>'referrer' AS referrer, count (*) AS views
      FROM page_views
      WHERE viewed_at BETWEEN p_from
        AND p_to
        AND redirect_info->>'referrer' IS NOT NULL
      GROUP BY referrer
      ORDER BY views DESC LIMIT 10) t;
...
CREATE
OR REPLACE FUNCTION "public"."handle_global_cooldown"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    AS $$
DECLARE
v_cooldown INTEGER;
...
IF
v_cooldown IS NOT NULL AND v_cooldown != 0 THEN
...
CREATE
OR REPLACE FUNCTION "public"."has_onlybart_access"() RETURNS boolean
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
BEGIN
...
FROM auth.users
WHERE id = auth.uid()
  AND raw_user_meta_data ->>'provider_id' = (SELECT raw_user_meta_data->>'provider_id' FROM auth.users WHERE id = auth.uid()))
    > 0 THEN
...
CREATE
OR REPLACE FUNCTION "public"."has_onlybart_view_access"() RETURNS boolean
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
BEGIN
...
CREATE
OR REPLACE FUNCTION "public"."is_broadcaster"() RETURNS boolean
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
BEGIN
...
CREATE
OR REPLACE FUNCTION "public"."is_broadcaster_role"() RETURNS boolean
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
BEGIN
RETURN EXISTS (SELECT 1
...
CREATE
OR REPLACE FUNCTION "public"."is_moderator"() RETURNS boolean
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
BEGIN
...
CREATE
OR REPLACE FUNCTION "public"."is_moderator_role"() RETURNS boolean
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
BEGIN
RETURN EXISTS (SELECT 1
...
CREATE
OR REPLACE FUNCTION "public"."is_vip_role"() RETURNS boolean
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
BEGIN
RETURN EXISTS (SELECT 1
...
CREATE
OR REPLACE FUNCTION "public"."redeem_reward"("p_twitch_user_id" "text", "p_reward_id" "text", "p_description" "text", "p_cost" integer, "p_ttstext" "text", "p_stream_id" "text") RETURNS "jsonb"
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
DECLARE
v_reward jsonb;
...
uuid;
  v_meta
jsonb := jsonb_build_object('description', p_description);
  v_expires
timestamptz;
  v_stream_end
timestamptz;
...
INTO v_reward
FROM rewards r
WHERE r.id = p_reward_id LIMIT 1;
IF
v_reward IS NULL THEN
...
IF
v_active_session IS NOT NULL THEN
...
IF
v_last IS NOT NULL AND v_cooldown > 0 THEN
...
VALUES (p_twitch_user_id, p_reward_id, now(), p_cost, p_description, p_ttstext) RETURNING id
INTO v_redeemed_id;
...
CREATE
OR REPLACE FUNCTION "public"."remove_moderator"("p_twitch_user_id" "text") RETURNS "jsonb"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
DECLARE
...
END IF;
  ...
  IF
NOT EXISTS(SELECT 1 FROM moderators WHERE twitch_user_id = v_caller_twitch_id) THEN
    RETURN jsonb_build_object('error', 'forbidden');
END IF;

  -- Sich selbst entfernen verhindern
  IF
p_twitch_user_id = v_caller_twitch_id THEN
    RETURN jsonb_build_object('error', 'cannot_remove_self');
END IF;

  -- Broadcaster kann nicht entfernt werden
  IF
EXISTS(SELECT 1 FROM moderators WHERE twitch_user_id = p_twitch_user_id AND is_broadcaster = true) THEN
...
FROM moderators
WHERE twitch_user_id = p_twitch_user_id ON CONFLICT (twitch_user_id) DO
UPDATE SET
    display_name = EXCLUDED.display_name,
    excluded_at = now();
...
CREATE
OR REPLACE FUNCTION "public"."reset_mod_sync_exclusions"() RETURNS "jsonb"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
DECLARE
...
CREATE
OR REPLACE FUNCTION "public"."rls_auto_enable"() RETURNS "event_trigger"
    LANGUAGE "plpgsql" SECURITY DEFINER
...
RAISE
LOG 'rls_auto_enable: enabled RLS on %', cmd.object_identity;
EXCEPTION
        WHEN OTHERS THEN
...
CREATE
OR REPLACE FUNCTION "public"."sync_moderators"("p_mods" "jsonb") RETURNS "jsonb"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
DECLARE
...
FROM jsonb_array_elements(p_mods) AS m ON CONFLICT (twitch_user_id) DO
...
CREATE
OR REPLACE FUNCTION "public"."sync_moderators"("p_mods" "jsonb", "p_broadcaster_twitch_id" "text" DEFAULT NULL::"text") RETURNS "jsonb"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
DECLARE
...
IF
v_caller_twitch_id IS NULL AND current_setting('request.jwt.claim.role', true) != 'service_role' THEN
...
:= COALESCE(
  ...
  v_is_broadcaster
:= (v_caller_twitch_id = v_broadcaster_id);

  -- Prüfen: Ist der Aufrufer ein Moderator?
SELECT EXISTS(SELECT 1
              FROM moderators
              WHERE twitch_user_id = v_caller_twitch_id)
INTO v_is_moderator;
...
CREATE
OR REPLACE FUNCTION "public"."sync_reward_columns"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    AS $$
BEGIN
...
CREATE
OR REPLACE FUNCTION "public"."transfer_permissions_to_roles"() RETURNS "jsonb"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
DECLARE
...
IF
NOT FOUND AND v_is_vip = false AND v_is_sub = false THEN
...
VALUES (v_user_id, v_is_sub, v_is_vip, v_is_mod, v_is_bc, now()) ON CONFLICT (user_id)
  DO
UPDATE SET
    is_subscriber = EXCLUDED.is_subscriber,
    is_vip = EXCLUDED.is_vip,
    is_moderator = CASE WHEN user_roles.is_moderator THEN true ELSE EXCLUDED.is_moderator
END,
    is_broadcaster = CASE WHEN user_roles.is_broadcaster THEN true ELSE EXCLUDED.is_broadcaster
END,
    last_synced_at = now();
...
CREATE
OR REPLACE VIEW "clipvoting"."clip_vote_counts" AS
SELECT "rc"."round_id",
       "rc"."clip_id",
       "c"."twitch_clip_id",
       "c"."title",
...
FROM (("clipvoting"."round_clips" "rc"
    ...
    LEFT JOIN (SELECT "votes"."round_id",
               ...
               GROUP BY "votes"."round_id", "votes"."clip_id") "vc"
      ON ((("vc"."round_id" = "rc"."round_id") AND ("vc"."clip_id" = "rc"."clip_id"))));


ALTER
VIEW "clipvoting"."clip_vote_counts" OWNER TO "postgres";
...
CREATE
OR REPLACE VIEW "onlybart"."onlybart_comments_with_profiles" WITH ("security_invoker"='on') AS
SELECT "c"."id",
       "c"."post_id",
       "c"."user_id",
       "c"."content",
...
ALTER
VIEW "onlybart"."onlybart_comments_with_profiles" OWNER TO "postgres";
...
(
    ...
    "type" "text",
    "created_at" timestamp with time zone DEFAULT "now"(),
    CONSTRAINT "onlybart_posts_type_check" CHECK
(
    (
    "type" =
    ANY (
...
CREATE
OR REPLACE TRIGGER "sync_reward_columns_trigger" BEFORE INSERT OR
UPDATE ON "public"."rewards" FOR EACH ROW EXECUTE FUNCTION "public"."sync_reward_columns"();



CREATE
OR REPLACE TRIGGER "trg_ensure_rewards_id" BEFORE INSERT ON "public"."rewards" FOR EACH ROW EXECUTE FUNCTION "public"."ensure_rewards_id"();



CREATE
OR REPLACE TRIGGER "trigger_redeem_global_cooldown" AFTER INSERT ON "public"."redeemed_rewards" FOR EACH ROW EXECUTE FUNCTION "public"."handle_global_cooldown"();



ALTER TABLE ONLY "clipvoting"."monthly_winners"
    ADD CONSTRAINT "monthly_winners_clip_id_fkey" FOREIGN KEY ("clip_id") REFERENCES "clipvoting"."clips"("id") ON
DELETE
CASCADE;
...
ALTER TABLE ONLY "clipvoting"."round_clips"
    ADD CONSTRAINT "round_clips_clip_id_fkey" FOREIGN KEY ("clip_id") REFERENCES "clipvoting"."clips"("id") ON
DELETE
CASCADE;
...
ALTER TABLE ONLY "clipvoting"."round_clips"
    ADD CONSTRAINT "round_clips_round_id_fkey" FOREIGN KEY ("round_id") REFERENCES "clipvoting"."voting_rounds"("id") ON
DELETE
CASCADE;
...
ALTER TABLE ONLY "clipvoting"."votes"
    ADD CONSTRAINT "votes_clip_id_fkey" FOREIGN KEY ("clip_id") REFERENCES "clipvoting"."clips"("id") ON
DELETE
CASCADE;
...
ALTER TABLE ONLY "clipvoting"."votes"
    ADD CONSTRAINT "votes_round_id_fkey" FOREIGN KEY ("round_id") REFERENCES "clipvoting"."voting_rounds"("id") ON
DELETE
CASCADE;
...
ALTER TABLE ONLY "clipvoting"."votes"
    ADD CONSTRAINT "votes_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "auth"."users"("id") ON
DELETE
CASCADE;
...
ALTER TABLE ONLY "clipvoting"."yearly_winners"
    ADD CONSTRAINT "yearly_winners_clip_id_fkey" FOREIGN KEY ("clip_id") REFERENCES "clipvoting"."clips"("id") ON
DELETE
CASCADE;
...
ALTER TABLE ONLY "onlybart"."onlybart_comments"
    ADD CONSTRAINT "onlybart_comments_post_id_fkey" FOREIGN KEY ("post_id") REFERENCES "onlybart"."onlybart_posts"("id") ON
DELETE
CASCADE;
...
ALTER TABLE ONLY "onlybart"."onlybart_comments"
    ADD CONSTRAINT "onlybart_comments_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "auth"."users"("id") ON
DELETE
CASCADE;
...
ALTER TABLE ONLY "onlybart"."onlybart_likes"
    ADD CONSTRAINT "onlybart_likes_post_id_fkey" FOREIGN KEY ("post_id") REFERENCES "onlybart"."onlybart_posts"("id") ON
DELETE
CASCADE;
...
ALTER TABLE ONLY "onlybart"."onlybart_likes"
    ADD CONSTRAINT "onlybart_likes_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "auth"."users"("id") ON
DELETE
CASCADE;
...
ALTER TABLE ONLY "public"."bartclicker_scores"
    ADD CONSTRAINT "bartclicker_scores_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "auth"."users"("id") ON
DELETE
CASCADE;
...
ALTER TABLE ONLY "public"."redeemed_global"
    ADD CONSTRAINT "redeemed_global_reward_id_fkey" FOREIGN KEY ("reward_id") REFERENCES "public"."rewards"("id") ON
DELETE
CASCADE;
...
ALTER TABLE ONLY "public"."redeemed_rewards"
    ADD CONSTRAINT "redeemed_rewards_reward_id_fkey" FOREIGN KEY ("reward_id") REFERENCES "public"."rewards"("id") ON
DELETE
CASCADE;
...
CREATE
POLICY "select" ON "clipvoting"."clips" FOR
SELECT USING (true);



CREATE
POLICY "select" ON "clipvoting"."monthly_winners" FOR
SELECT USING (true);



CREATE
POLICY "select" ON "clipvoting"."round_clips" FOR
SELECT USING (true);



CREATE
POLICY "select" ON "clipvoting"."votes" FOR
SELECT USING (true);



CREATE
POLICY "select" ON "clipvoting"."voting_rounds" FOR
SELECT USING (true);



CREATE
POLICY "select" ON "clipvoting"."yearly_winners" FOR
SELECT USING (true);
...
CREATE
POLICY "All logged-in users can insert comments" ON "onlybart"."onlybart_comments" FOR INSERT WITH CHECK (("auth"."role"() = 'authenticated'::"text"));



CREATE
POLICY "All logged-in users can insert likes, superlike nur VIP/Mod" ON "onlybart"."onlybart_likes" FOR INSERT WITH CHECK ((("auth"."role"() = 'authenticated'::"text") AND (NOT "public"."is_broadcaster_role"()) AND (("is_superlike" = false) OR (("is_superlike" = true) AND ("public"."is_vip_role"() OR "public"."is_moderator_role"())))));



CREATE
POLICY "All logged-in users can view comments" ON "onlybart"."onlybart_comments" FOR
SELECT USING (("auth"."role"() = 'authenticated'::"text"));



CREATE
POLICY "All logged-in users can view likes" ON "onlybart"."onlybart_likes" FOR
SELECT USING (("auth"."role"() = 'authenticated'::"text"));



CREATE
POLICY "All logged-in users can view posts" ON "onlybart"."onlybart_posts" FOR
SELECT USING (("auth"."role"() = 'authenticated'::"text"));



CREATE
POLICY "Broadcaster can delete own posts" ON "onlybart"."onlybart_posts" FOR DELETE
USING ("public"."is_broadcaster_role"());



CREATE
POLICY "Broadcaster can insert posts" ON "onlybart"."onlybart_posts" FOR INSERT WITH CHECK ((EXISTS ( SELECT 1
...
CREATE
POLICY "Broadcaster can update own posts" ON "onlybart"."onlybart_posts" FOR
...
CREATE
POLICY "User kann eigenen Kommentar löschen, Mod/Broadcaster alle" ON "onlybart"."onlybart_comments" FOR DELETE
USING ((("auth"."uid"() = "user_id") OR "public"."is_moderator_role"() OR "public"."is_broadcaster_role"()));



CREATE
POLICY "Users can remove own likes" ON "onlybart"."onlybart_likes" FOR DELETE
...
CREATE
POLICY "Allow select for authenticated users" ON "public"."rewards" FOR
SELECT USING (("auth"."role"() = 'authenticated'::"text"));



CREATE
POLICY "Anyone can read twitch_permissions" ON "public"."twitch_permissions" FOR
SELECT USING (true);



CREATE
POLICY "Broadcaster can insert twitch_permissions" ON "public"."twitch_permissions" FOR INSERT WITH CHECK ((EXISTS ( SELECT 1
   FROM "public"."user_roles"
  WHERE (("user_roles"."user_id" = "auth"."uid"()) AND ("user_roles"."is_broadcaster" = true)))));
...
CREATE
POLICY "Broadcaster can update twitch_permissions" ON "public"."twitch_permissions" USING ((EXISTS ( SELECT 1
   FROM "public"."user_roles"
  WHERE (("user_roles"."user_id" = "auth"."uid"()) AND ("user_roles"."is_broadcaster" = true)))));
...
CREATE
POLICY "Check Twitch Ban" ON "public"."moderators" USING ((NOT (EXISTS ( SELECT 1
   FROM "public"."banned_accounts"
...
CREATE
POLICY "Check Twitch Ban" ON "public"."points" USING ((NOT (EXISTS ( SELECT 1
   FROM "public"."banned_accounts"
  WHERE ("banned_accounts"."twitch_user_id" = (("auth"."jwt"() -> 'user_metadata'::"text") ->> 'provider_id'::"text"))))));
...
CREATE
POLICY "Moderatoren können Punkte verwalten" ON "public"."points" USING ((("current_setting"('request.jwt.claim.role'::"text", true) = 'service_role'::"text") OR "public"."is_moderator_role"() OR "public"."is_broadcaster_role"())) WITH CHECK ((("current_setting"('request.jwt.claim.role'::"text", true) = 'service_role'::"text") OR "public"."is_moderator_role"() OR "public"."is_broadcaster_role"()));



CREATE
POLICY "Moderatoren/Broadcaster können Rewards löschen" ON "public"."rewards" FOR DELETE
USING ((("current_setting"('request.jwt.claim.role'::"text", true) = 'service_role'::"text") OR "public"."is_moderator_role"() OR "public"."is_broadcaster_role"()));



CREATE
POLICY "Nutzer können eigene Punkte sehen" ON "public"."points" FOR
SELECT USING (("twitch_user_id" = (("auth"."jwt"() -> 'user_metadata'::"text") ->> 'provider_id'::"text")));



CREATE
POLICY "Profiles are public" ON "public"."profiles" FOR
SELECT USING (true);
...
CREATE
POLICY "Users can insert their own redeemed rewards" ON "public"."redeemed_rewards" FOR INSERT WITH CHECK (("auth"."uid"() IS NOT NULL));



CREATE
POLICY "Users can read own roles" ON "public"."user_roles" FOR
...
CREATE
POLICY "delete_banned" ON "public"."banned_accounts" FOR DELETE
USING ("public"."is_broadcaster"());



CREATE
POLICY "delete_mod_sync_excluded" ON "public"."mod_sync_excluded" FOR DELETE
USING (("auth"."uid"() IS NOT NULL));



CREATE
POLICY "delete_moderator" ON "public"."bartclicker_scores" FOR DELETE
USING ("public"."is_moderator"());



CREATE
POLICY "insert_anon" ON "public"."page_views" FOR INSERT WITH CHECK (true);



CREATE
POLICY "insert_banned" ON "public"."banned_accounts" FOR INSERT WITH CHECK ("public"."is_broadcaster"());



CREATE
POLICY "insert_self" ON "public"."bartclicker_scores" FOR INSERT WITH CHECK (("auth"."uid"() = "user_id"));
...
CREATE
POLICY "select" ON "public"."moderators" FOR
SELECT USING (true);



CREATE
POLICY "select_banned" ON "public"."banned_accounts" FOR
SELECT USING ("public"."is_moderator"());



CREATE
POLICY "select_mod" ON "public"."page_views" FOR
SELECT USING ("public"."is_moderator"());



CREATE
POLICY "select_mod_sync_excluded" ON "public"."mod_sync_excluded" FOR
SELECT USING (true);



CREATE
POLICY "select_own_ban" ON "public"."banned_accounts" FOR
SELECT USING ((("twitch_user_id" = ((("auth"."jwt"())::json -> 'user_metadata'::"text") ->> 'provider_id'::"text")) OR "public"."is_moderator"()));



CREATE
POLICY "select_public" ON "public"."bartclicker_scores" FOR
SELECT USING (true);
...
CREATE
POLICY "update_self" ON "public"."bartclicker_scores" FOR
...
"clipvoting" TO "anon";
GRANT USAGE ON SCHEMA
"clipvoting" TO "authenticated";
GRANT USAGE ON SCHEMA
"clipvoting" TO "service_role";
...
GRANT ALL
ON FUNCTION "public"."add_moderator"("p_twitch_user_id" "text", "p_display_name" "text") TO "anon";
GRANT ALL
ON FUNCTION "public"."add_moderator"("p_twitch_user_id" "text", "p_display_name" "text") TO "authenticated";
GRANT ALL
ON FUNCTION "public"."add_moderator"("p_twitch_user_id" "text", "p_display_name" "text") TO "service_role";



GRANT ALL
ON FUNCTION "public"."admin_ban_account"("p_twitch_user_id" "text", "p_display_name" "text", "p_banned_by" "text") TO "anon";
GRANT ALL
ON FUNCTION "public"."admin_ban_account"("p_twitch_user_id" "text", "p_display_name" "text", "p_banned_by" "text") TO "authenticated";
GRANT ALL
ON FUNCTION "public"."admin_ban_account"("p_twitch_user_id" "text", "p_display_name" "text", "p_banned_by" "text") TO "service_role";



GRANT ALL
ON FUNCTION "public"."admin_ban_account"("p_twitch_user_id" "text", "p_display_name" "text", "p_banned_by" "text", "p_reason" "text") TO "anon";
GRANT ALL
ON FUNCTION "public"."admin_ban_account"("p_twitch_user_id" "text", "p_display_name" "text", "p_banned_by" "text", "p_reason" "text") TO "authenticated";
GRANT ALL
ON FUNCTION "public"."admin_ban_account"("p_twitch_user_id" "text", "p_display_name" "text", "p_banned_by" "text", "p_reason" "text") TO "service_role";



GRANT ALL
ON FUNCTION "public"."admin_delete_reward"("p_id" "text") TO "anon";
GRANT ALL
ON FUNCTION "public"."admin_delete_reward"("p_id" "text") TO "authenticated";
GRANT ALL
ON FUNCTION "public"."admin_delete_reward"("p_id" "text") TO "service_role";



GRANT ALL
ON FUNCTION "public"."admin_end_round2"() TO "anon";
GRANT ALL
ON FUNCTION "public"."admin_end_round2"() TO "authenticated";
GRANT ALL
ON FUNCTION "public"."admin_end_round2"() TO "service_role";



GRANT ALL
ON FUNCTION "public"."admin_end_yearly"() TO "anon";
GRANT ALL
ON FUNCTION "public"."admin_end_yearly"() TO "authenticated";
GRANT ALL
ON FUNCTION "public"."admin_end_yearly"() TO "service_role";



GRANT ALL
ON FUNCTION "public"."admin_start_round2"() TO "anon";
GRANT ALL
ON FUNCTION "public"."admin_start_round2"() TO "authenticated";
GRANT ALL
ON FUNCTION "public"."admin_start_round2"() TO "service_role";



GRANT ALL
ON FUNCTION "public"."admin_start_yearly"() TO "anon";
GRANT ALL
ON FUNCTION "public"."admin_start_yearly"() TO "authenticated";
GRANT ALL
ON FUNCTION "public"."admin_start_yearly"() TO "service_role";



GRANT ALL
ON FUNCTION "public"."admin_unban_account"("p_twitch_user_id_int" integer) TO "anon";
GRANT ALL
ON FUNCTION "public"."admin_unban_account"("p_twitch_user_id_int" integer) TO "authenticated";
GRANT ALL
ON FUNCTION "public"."admin_unban_account"("p_twitch_user_id_int" integer) TO "service_role";



GRANT ALL
ON FUNCTION "public"."admin_unban_account"("p_twitch_user_id" "text") TO "anon";
GRANT ALL
ON FUNCTION "public"."admin_unban_account"("p_twitch_user_id" "text") TO "authenticated";
GRANT ALL
ON FUNCTION "public"."admin_unban_account"("p_twitch_user_id" "text") TO "service_role";



GRANT ALL
ON FUNCTION "public"."admin_unban_account"("p_twitch_user_id_uuid" "uuid") TO "anon";
GRANT ALL
ON FUNCTION "public"."admin_unban_account"("p_twitch_user_id_uuid" "uuid") TO "authenticated";
GRANT ALL
ON FUNCTION "public"."admin_unban_account"("p_twitch_user_id_uuid" "uuid") TO "service_role";



GRANT ALL
ON FUNCTION "public"."admin_unban_account_json"("p_payload" json) TO "anon";
GRANT ALL
ON FUNCTION "public"."admin_unban_account_json"("p_payload" json) TO "authenticated";
GRANT ALL
ON FUNCTION "public"."admin_unban_account_json"("p_payload" json) TO "service_role";



GRANT ALL
ON FUNCTION "public"."admin_unban_account_text"("p_twitch_user_id" "text") TO "anon";
GRANT ALL
ON FUNCTION "public"."admin_unban_account_text"("p_twitch_user_id" "text") TO "authenticated";
GRANT ALL
ON FUNCTION "public"."admin_unban_account_text"("p_twitch_user_id" "text") TO "service_role";



GRANT ALL
ON FUNCTION "public"."cast_vote"("p_round_id" "uuid", "p_clip_id" "uuid") TO "anon";
GRANT ALL
ON FUNCTION "public"."cast_vote"("p_round_id" "uuid", "p_clip_id" "uuid") TO "authenticated";
GRANT ALL
ON FUNCTION "public"."cast_vote"("p_round_id" "uuid", "p_clip_id" "uuid") TO "service_role";



GRANT ALL
ON FUNCTION "public"."check_ban_before_login"("event" "jsonb") TO "anon";
GRANT ALL
ON FUNCTION "public"."check_ban_before_login"("event" "jsonb") TO "authenticated";
GRANT ALL
ON FUNCTION "public"."check_ban_before_login"("event" "jsonb") TO "service_role";



GRANT ALL
ON FUNCTION "public"."deactivate_all_active_redeemed_global"() TO "anon";
GRANT ALL
ON FUNCTION "public"."deactivate_all_active_redeemed_global"() TO "authenticated";
GRANT ALL
ON FUNCTION "public"."deactivate_all_active_redeemed_global"() TO "service_role";



GRANT ALL
ON FUNCTION "public"."deactivate_expired_redeemed_global"() TO "anon";
GRANT ALL
ON FUNCTION "public"."deactivate_expired_redeemed_global"() TO "authenticated";
GRANT ALL
ON FUNCTION "public"."deactivate_expired_redeemed_global"() TO "service_role";



GRANT ALL
ON FUNCTION "public"."deactivate_redeemed_global_for_session"("p_session_id" "text") TO "anon";
GRANT ALL
ON FUNCTION "public"."deactivate_redeemed_global_for_session"("p_session_id" "text") TO "authenticated";
GRANT ALL
ON FUNCTION "public"."deactivate_redeemed_global_for_session"("p_session_id" "text") TO "service_role";



GRANT ALL
ON FUNCTION "public"."ensure_rewards_id"() TO "anon";
GRANT ALL
ON FUNCTION "public"."ensure_rewards_id"() TO "authenticated";
GRANT ALL
ON FUNCTION "public"."ensure_rewards_id"() TO "service_role";



GRANT ALL
ON FUNCTION "public"."get_bartclicker_leaderboard"("p_limit" integer) TO "anon";
GRANT ALL
ON FUNCTION "public"."get_bartclicker_leaderboard"("p_limit" integer) TO "authenticated";
GRANT ALL
ON FUNCTION "public"."get_bartclicker_leaderboard"("p_limit" integer) TO "service_role";



GRANT ALL
ON FUNCTION "public"."get_bartclicker_leaderboard_with_names"("p_limit" integer) TO "anon";
GRANT ALL
ON FUNCTION "public"."get_bartclicker_leaderboard_with_names"("p_limit" integer) TO "authenticated";
GRANT ALL
ON FUNCTION "public"."get_bartclicker_leaderboard_with_names"("p_limit" integer) TO "service_role";



GRANT ALL
ON FUNCTION "public"."get_page_view_stats"("p_from" timestamp with time zone, "p_to" timestamp with time zone) TO "anon";
GRANT ALL
ON FUNCTION "public"."get_page_view_stats"("p_from" timestamp with time zone, "p_to" timestamp with time zone) TO "authenticated";
GRANT ALL
ON FUNCTION "public"."get_page_view_stats"("p_from" timestamp with time zone, "p_to" timestamp with time zone) TO "service_role";



GRANT ALL
ON FUNCTION "public"."handle_global_cooldown"() TO "anon";
GRANT ALL
ON FUNCTION "public"."handle_global_cooldown"() TO "authenticated";
GRANT ALL
ON FUNCTION "public"."handle_global_cooldown"() TO "service_role";



GRANT ALL
ON FUNCTION "public"."has_onlybart_access"() TO "anon";
GRANT ALL
ON FUNCTION "public"."has_onlybart_access"() TO "authenticated";
GRANT ALL
ON FUNCTION "public"."has_onlybart_access"() TO "service_role";



GRANT ALL
ON FUNCTION "public"."has_onlybart_view_access"() TO "anon";
GRANT ALL
ON FUNCTION "public"."has_onlybart_view_access"() TO "authenticated";
GRANT ALL
ON FUNCTION "public"."has_onlybart_view_access"() TO "service_role";



GRANT ALL
ON FUNCTION "public"."is_broadcaster"() TO "anon";
GRANT ALL
ON FUNCTION "public"."is_broadcaster"() TO "authenticated";
GRANT ALL
ON FUNCTION "public"."is_broadcaster"() TO "service_role";



GRANT ALL
ON FUNCTION "public"."is_broadcaster_role"() TO "anon";
GRANT ALL
ON FUNCTION "public"."is_broadcaster_role"() TO "authenticated";
GRANT ALL
ON FUNCTION "public"."is_broadcaster_role"() TO "service_role";



GRANT ALL
ON FUNCTION "public"."is_moderator"() TO "anon";
GRANT ALL
ON FUNCTION "public"."is_moderator"() TO "authenticated";
GRANT ALL
ON FUNCTION "public"."is_moderator"() TO "service_role";



GRANT ALL
ON FUNCTION "public"."is_moderator_role"() TO "anon";
GRANT ALL
ON FUNCTION "public"."is_moderator_role"() TO "authenticated";
GRANT ALL
ON FUNCTION "public"."is_moderator_role"() TO "service_role";



GRANT ALL
ON FUNCTION "public"."is_vip_role"() TO "anon";
GRANT ALL
ON FUNCTION "public"."is_vip_role"() TO "authenticated";
GRANT ALL
ON FUNCTION "public"."is_vip_role"() TO "service_role";



GRANT ALL
ON FUNCTION "public"."redeem_reward"("p_twitch_user_id" "text", "p_reward_id" "text", "p_description" "text", "p_cost" integer, "p_ttstext" "text", "p_stream_id" "text") TO "anon";
GRANT ALL
ON FUNCTION "public"."redeem_reward"("p_twitch_user_id" "text", "p_reward_id" "text", "p_description" "text", "p_cost" integer, "p_ttstext" "text", "p_stream_id" "text") TO "authenticated";
GRANT ALL
ON FUNCTION "public"."redeem_reward"("p_twitch_user_id" "text", "p_reward_id" "text", "p_description" "text", "p_cost" integer, "p_ttstext" "text", "p_stream_id" "text") TO "service_role";



GRANT ALL
ON FUNCTION "public"."remove_moderator"("p_twitch_user_id" "text") TO "anon";
GRANT ALL
ON FUNCTION "public"."remove_moderator"("p_twitch_user_id" "text") TO "authenticated";
GRANT ALL
ON FUNCTION "public"."remove_moderator"("p_twitch_user_id" "text") TO "service_role";



GRANT ALL
ON FUNCTION "public"."reset_mod_sync_exclusions"() TO "anon";
GRANT ALL
ON FUNCTION "public"."reset_mod_sync_exclusions"() TO "authenticated";
GRANT ALL
ON FUNCTION "public"."reset_mod_sync_exclusions"() TO "service_role";



GRANT ALL
ON FUNCTION "public"."rls_auto_enable"() TO "anon";
GRANT ALL
ON FUNCTION "public"."rls_auto_enable"() TO "authenticated";
GRANT ALL
ON FUNCTION "public"."rls_auto_enable"() TO "service_role";



GRANT ALL
ON FUNCTION "public"."sync_moderators"("p_mods" "jsonb") TO "anon";
GRANT ALL
ON FUNCTION "public"."sync_moderators"("p_mods" "jsonb") TO "authenticated";
GRANT ALL
ON FUNCTION "public"."sync_moderators"("p_mods" "jsonb") TO "service_role";



GRANT ALL
ON FUNCTION "public"."sync_moderators"("p_mods" "jsonb", "p_broadcaster_twitch_id" "text") TO "anon";
GRANT ALL
ON FUNCTION "public"."sync_moderators"("p_mods" "jsonb", "p_broadcaster_twitch_id" "text") TO "authenticated";
GRANT ALL
ON FUNCTION "public"."sync_moderators"("p_mods" "jsonb", "p_broadcaster_twitch_id" "text") TO "service_role";



GRANT ALL
ON FUNCTION "public"."sync_reward_columns"() TO "anon";
GRANT ALL
ON FUNCTION "public"."sync_reward_columns"() TO "authenticated";
GRANT ALL
ON FUNCTION "public"."sync_reward_columns"() TO "service_role";



GRANT ALL
ON FUNCTION "public"."transfer_permissions_to_roles"() TO "anon";
GRANT ALL
ON FUNCTION "public"."transfer_permissions_to_roles"() TO "authenticated";
GRANT ALL
ON FUNCTION "public"."transfer_permissions_to_roles"() TO "service_role";
...
GRANT ALL
ON TABLE "clipvoting"."clips" TO "anon";
GRANT ALL
ON TABLE "clipvoting"."clips" TO "authenticated";
GRANT ALL
ON TABLE "clipvoting"."clips" TO "service_role";



GRANT ALL
ON TABLE "clipvoting"."round_clips" TO "anon";
GRANT ALL
ON TABLE "clipvoting"."round_clips" TO "authenticated";
GRANT ALL
ON TABLE "clipvoting"."round_clips" TO "service_role";



GRANT ALL
ON TABLE "clipvoting"."votes" TO "anon";
GRANT ALL
ON TABLE "clipvoting"."votes" TO "authenticated";
GRANT ALL
ON TABLE "clipvoting"."votes" TO "service_role";



GRANT ALL
ON TABLE "clipvoting"."clip_vote_counts" TO "anon";
GRANT ALL
ON TABLE "clipvoting"."clip_vote_counts" TO "authenticated";
GRANT ALL
ON TABLE "clipvoting"."clip_vote_counts" TO "service_role";



GRANT ALL
ON TABLE "clipvoting"."monthly_winners" TO "anon";
GRANT ALL
ON TABLE "clipvoting"."monthly_winners" TO "authenticated";
GRANT ALL
ON TABLE "clipvoting"."monthly_winners" TO "service_role";



GRANT ALL
ON TABLE "clipvoting"."voting_rounds" TO "anon";
GRANT ALL
ON TABLE "clipvoting"."voting_rounds" TO "authenticated";
GRANT ALL
ON TABLE "clipvoting"."voting_rounds" TO "service_role";



GRANT ALL
ON TABLE "clipvoting"."yearly_winners" TO "anon";
GRANT ALL
ON TABLE "clipvoting"."yearly_winners" TO "authenticated";
GRANT ALL
ON TABLE "clipvoting"."yearly_winners" TO "service_role";
...
GRANT ALL
ON TABLE "onlybart"."onlybart_comments" TO "anon";
GRANT ALL
ON TABLE "onlybart"."onlybart_comments" TO "authenticated";
GRANT ALL
ON TABLE "onlybart"."onlybart_comments" TO "service_role";
...
GRANT ALL
ON TABLE "onlybart"."onlybart_comments_with_profiles" TO "anon";
GRANT ALL
ON TABLE "onlybart"."onlybart_comments_with_profiles" TO "authenticated";
GRANT ALL
ON TABLE "onlybart"."onlybart_comments_with_profiles" TO "service_role";



GRANT ALL
ON TABLE "onlybart"."onlybart_likes" TO "anon";
GRANT ALL
ON TABLE "onlybart"."onlybart_likes" TO "authenticated";
GRANT ALL
ON TABLE "onlybart"."onlybart_likes" TO "service_role";



GRANT ALL
ON TABLE "onlybart"."onlybart_posts" TO "anon";
GRANT ALL
ON TABLE "onlybart"."onlybart_posts" TO "authenticated";
GRANT ALL
ON TABLE "onlybart"."onlybart_posts" TO "service_role";



GRANT ALL
ON TABLE "public"."banned_accounts" TO "anon";
GRANT ALL
ON TABLE "public"."banned_accounts" TO "authenticated";
GRANT ALL
ON TABLE "public"."banned_accounts" TO "service_role";



GRANT ALL
ON TABLE "public"."bartclicker_scores" TO "anon";
GRANT ALL
ON TABLE "public"."bartclicker_scores" TO "authenticated";
GRANT ALL
ON TABLE "public"."bartclicker_scores" TO "service_role";



GRANT ALL
ON TABLE "public"."mod_sync_excluded" TO "anon";
GRANT ALL
ON TABLE "public"."mod_sync_excluded" TO "authenticated";
GRANT ALL
ON TABLE "public"."mod_sync_excluded" TO "service_role";



GRANT ALL
ON TABLE "public"."moderators" TO "anon";
GRANT ALL
ON TABLE "public"."moderators" TO "authenticated";
GRANT ALL
ON TABLE "public"."moderators" TO "service_role";



GRANT ALL
ON TABLE "public"."page_views" TO "anon";
GRANT ALL
ON TABLE "public"."page_views" TO "authenticated";
GRANT ALL
ON TABLE "public"."page_views" TO "service_role";



GRANT ALL
ON SEQUENCE "public"."page_views_id_seq" TO "anon";
GRANT ALL
ON SEQUENCE "public"."page_views_id_seq" TO "authenticated";
GRANT ALL
ON SEQUENCE "public"."page_views_id_seq" TO "service_role";
...
GRANT ALL
ON TABLE "public"."points" TO "authenticated";
GRANT ALL
ON TABLE "public"."points" TO "service_role";



GRANT ALL
ON TABLE "public"."redeemed_global" TO "anon";
GRANT ALL
ON TABLE "public"."redeemed_global" TO "authenticated";
GRANT ALL
ON TABLE "public"."redeemed_global" TO "service_role";



GRANT ALL
ON TABLE "public"."redeemed_rewards" TO "anon";
GRANT ALL
ON TABLE "public"."redeemed_rewards" TO "authenticated";
GRANT ALL
ON TABLE "public"."redeemed_rewards" TO "service_role";



GRANT ALL
ON TABLE "public"."rewards" TO "anon";
GRANT ALL
ON TABLE "public"."rewards" TO "authenticated";
GRANT ALL
ON TABLE "public"."rewards" TO "service_role";



GRANT ALL
ON TABLE "public"."stream_sessions" TO "anon";
GRANT ALL
ON TABLE "public"."stream_sessions" TO "authenticated";
GRANT ALL
ON TABLE "public"."stream_sessions" TO "service_role";



GRANT ALL
ON TABLE "public"."twitch_permissions" TO "anon";
GRANT ALL
ON TABLE "public"."twitch_permissions" TO "authenticated";
GRANT ALL
ON TABLE "public"."twitch_permissions" TO "service_role";



GRANT ALL
ON TABLE "public"."user_roles" TO "anon";
GRANT ALL
...
SELECT vault.create_secret('APIKEY123456789', 'discord_api_key');
-- TODO: CHANGEIT ON CREATION
...
AS $$
DECLARE
v_run_at  timestamptz := now() + interval '120 seconds';
...
IF v_key IS NULL THEN
    RAISE EXCEPTION 'discord_api_key not found in vault';
END IF;

  PERFORM cron.schedule(
    v_jobname,
    to_char(v_run_at, 'MI HH24 DD MM') || ' *',
    format(
      $job$
        SELECT net.http_post(
          url     := 'https://ptp4-landingpage-twitch-hd.onrender.com%s',
